...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab result
...
module  fp_multer_altfp_mult_rln
	( 
	clock,
	dataa,
	datab,
...
endmodule //fp_multer_altfp_mult_rln
//VALID FILE
...
module fp_multer (
	...
	fp_multer_altfp_mult_rln	fp_multer_altfp_mult_rln_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
